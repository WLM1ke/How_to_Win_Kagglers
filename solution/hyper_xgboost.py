...
SPACE = dict(
    ...
    learning_rate=0.3,
    n_estimators=200,
    max_depth=hp.choice("depth", list(range(1, 17))),
    min_child_weight=hp.loguniform("l2_leaf_reg", np.log(1), np.log(10000)),
)

if sys.platform == "darwin":
    del SPACE["tree_method"]
...
if __name__ == '__main__':
    ...
    opt = XGBoostHyper((x_train, y_train), (x_valid, y_valid))
    hyperopt.fmin(
        opt,
        space=SPACE,
